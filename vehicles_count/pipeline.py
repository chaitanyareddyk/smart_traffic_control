...
class PipelineRunner(object):
    ...
    def run(self):
        ...
        self.log.debug("Frame #%d is processed.", self.context['frame_number'])
...
class VehicleCounter(PipelineProcessor):
    ...
    def __call__(self, context):
        ...
        self.log.debug('No. of Vehicle Found: %s' % self.vehicle_count)
...
class Visualizer(PipelineProcessor):
    ...
    def draw_ui(self, img, vehicle_count, exit_masks=[]):
        ...
        cv2.putText(img, ("SIH-2K19 - SMART TRAFFIC LIGHTS USING EXISTING CCTV CAMERS - POC               Vehicles Count: {total} ".format(total=vehicle_count)), (30, 30),
